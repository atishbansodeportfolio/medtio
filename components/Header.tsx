  ...
  return (
    <header className="absolute top-0 left-0 right-0 z-50 px-6 py-4 flex justify-between items-center max-w-7xl mx-auto w-full">
      ...
      <nav className="hidden md:flex items-center space-x-6 text-sm font-medium">
        <Link href="/ivf-clinics/mumbai" className="text-gray-600 hover:text-teal-600 dark:text-gray-300 dark:hover:text-teal-400 transition-colors">All Clinics</Link>
