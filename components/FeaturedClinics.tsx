    ...
    <section className="py-20 bg-gray-50 dark:bg-gray-900/30">
      <div className="max-w-7xl mx-auto px-6">
        <div className="flex justify-between items-end mb-10">
          <div>
            <h2 className="text-3xl font-bold text-gray-900 dark:text-white mb-2">Featured Clinics</h2>
            <p className="text-gray-600 dark:text-gray-400">Discover top-rated fertility centers across India</p>
          </div>
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
          {clinics?.map((clinic: any) => (
            <div key={clinic.id} className="bg-white dark:bg-gray-800 rounded-2xl shadow-sm border border-gray-100 dark:border-gray-700 overflow-hidden hover:shadow-lg transition-shadow duration-300">
              ...
              <div className="p-6">
                <div className="flex justify-between items-start mb-2">
                  <h3 className="text-xl font-bold text-gray-900 dark:text-white line-clamp-1">{clinic.name}</h3>
          ...
          {(!clinics || clinics.length === 0) && (
            <div className="col-span-full py-12 text-center bg-white dark:bg-gray-800 rounded-2xl border border-gray-100 dark:border-gray-700">
              <p className="text-gray-500 dark:text-gray-400 font-medium">No clinics available to display.</p>
            </div>
          )}
        </div>
      </div>
