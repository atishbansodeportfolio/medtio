        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            ...
            <div key={clinic.id} className="bg-white  rounded-2xl shadow-sm border border-gray-100  overflow-hidden hover:shadow-lg transition-shadow duration-300">
              ...
              <div className="p-6">
                ...
                <Link 
                  ...
                  className="block w-full text-center bg-teal-50  text-teal-600  hover:bg-teal-100 :bg-teal-900/40 font-medium py-2.5 rounded-lg transition-colors"
                >
                  View Details
                </Link>
              </div>
          ...
          {(!clinics || clinics.length === 0) && (
            <div className="col-span-full py-12 text-center bg-white  rounded-2xl border border-gray-100 ">
              <p className="text-gray-500  font-medium">No hospitals available to display.</p>
            </div>
          )}
        </div>
      </div>
