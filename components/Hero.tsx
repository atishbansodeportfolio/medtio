export default function Hero() {
  return (
    <section className="relative pt-32 pb-20 lg:pt-48 lg:pb-32 overflow-hidden">
      <div className="absolute inset-0 bg-gradient-to-b from-teal-50 to-white   -z-10" />
      <div className="max-w-7xl mx-auto px-6 text-center">
        ...
        <div className="max-w-4xl mx-auto bg-white  p-2 md:p-3 rounded-2xl md:rounded-full shadow-lg flex flex-col md:flex-row items-center gap-2 border border-gray-100 ">
          <div className="flex-1 w-full flex items-center px-4 py-1 border-b md:border-b-0 md:border-r border-gray-100 ">
