      ...
      <div className="max-w-7xl mx-auto px-6">
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
          {doctors?.map((doctor: any) => (
            <div key={doctor.id} className="bg-white dark:bg-gray-800 rounded-2xl p-6 border border-gray-100 dark:border-gray-700 text-center flex flex-col items-center hover:shadow-md transition-shadow group">
              <div className="w-24 h-24 rounded-full bg-teal-50 dark:bg-gray-700 mb-4 overflow-hidden flex items-center justify-center border-2 border-transparent group-hover:border-teal-200 transition-colors">
                 {doctor.image_url ? (
              ...
              <h3 className="text-lg font-bold text-gray-900 dark:text-white line-clamp-1">{doctor.name}</h3>
              ...
              <Link 
                ...
                className="w-full bg-transparent border border-teal-600 text-teal-600 hover:bg-teal-50 dark:hover:bg-teal-900/30 py-2 rounded-lg text-sm font-semibold transition-colors text-center"
              >
                View Profile
              </Link>
            </div>
          ...
          {(!doctors || doctors.length === 0) && (
            <div className="col-span-full py-12 text-center bg-white dark:bg-gray-800 rounded-2xl border border-gray-100 dark:border-gray-700">
              <p className="text-gray-500 dark:text-gray-400 font-medium">No doctors available to display.</p>
            </div>
          )}
        </div>
      </div>
