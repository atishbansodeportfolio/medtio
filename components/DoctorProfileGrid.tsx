        ...
        {doctors?.map((doctor: any) => (
          ...
          >
            <div className="p-6 flex-grow flex flex-col items-center text-center">
              <div className="w-24 h-24 rounded-full bg-teal-50  mb-4 overflow-hidden flex items-center justify-center border-2 border-teal-100 ">
                {doctor.image_url ? (
              ...
              <div className="w-full space-y-2 mt-2">
                <div className="flex justify-between items-center text-sm border-b border-gray-50  pb-2">
                  ...
                  <span className="font-semibold text-gray-800 ">{doctor.clinic_name || 'N/A'}</span>
                </div>
                <div className="flex justify-between items-center text-sm border-b border-gray-50  pb-2">
                  <span className="text-gray-500 ">Experience</span>
                  <span className="font-semibold text-gray-800 ">{doctor.experience_years ? `${doctor.experience_years} years` : 'N/A'}</span>
                </div>
                <div className="flex justify-between items-center text-sm pt-1">
                  <span className="text-gray-500 ">Rating</span>
                  <div className="flex items-center">
                    <span className="font-semibold text-gray-800  mr-1">{doctor.rating || 'N/A'}</span>
