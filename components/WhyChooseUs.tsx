    ...
    <section className="py-20 bg-white dark:bg-background border-t border-gray-100 dark:border-gray-800">
      <div className="max-w-7xl mx-auto px-6">
        <div className="text-center mb-16">
          <h2 className="text-3xl font-bold text-gray-900 dark:text-white mb-4">Why Choose Medtio</h2>
          <p className="text-gray-600 dark:text-gray-400 max-w-2xl mx-auto text-lg">We simplify the process of finding the right healthcare by providing transparency, trusted reviews, and verified data.</p>
        </div>
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
          {FEATURES.map((feature, i) => (
            <div key={i} className="text-center group">
              <div className="w-16 h-16 mx-auto bg-teal-50 dark:bg-teal-900/30 group-hover:bg-teal-100 dark:group-hover:bg-teal-900/50 transition-colors rounded-2xl flex items-center justify-center mb-6 shadow-sm">
                {feature.icon}
              </div>
