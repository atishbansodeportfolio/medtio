          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="max-w-3xl">
              <h1 className="text-4xl md:text-5xl font-extrabold text-gray-900 dark:text-white tracking-tight mb-6 mt-10">
                Top 10 Gynecology Clinics in <span className="text-teal-600 dark:text-teal-400">{displayCity}</span>
              </h1>
          ...
          <div className="flex flex-col lg:flex-row lg:items-start justify-between gap-10 mt-10">
            ...
            <div className="lg:w-80 flex-shrink-0 bg-white dark:bg-gray-800 p-6 rounded-2xl border border-gray-200 dark:border-gray-700 shadow-xl lg:sticky lg:top-24">
              ...
              <div className="space-y-4">
                ...
                <Link href={`/gynecology-clinics/${clinic.city_slug}`} className="w-full flex items-center justify-center gap-2 py-3 px-4 bg-gray-50 dark:bg-gray-800 text-gray-700 dark:text-gray-300 hover:bg-gray-100 dark:hover:bg-gray-700 font-bold rounded-xl transition-colors border border-gray-200 dark:border-gray-600 text-sm">
                   Compare Clinics
                </Link>
              </div>
            </div>
          ...
          <div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div className="bg-white dark:bg-gray-800 p-6 rounded-2xl border border-gray-100 dark:border-gray-700 shadow-sm flex items-start gap-4">
                ...
                <div>
                  <h3 className="font-bold text-gray-900 dark:text-white mb-1">Expert Care</h3>
                  <p className="text-sm text-gray-500 dark:text-gray-400">Maintaining highly audited facilities and clinical standards for women's health.</p>
                </div>
              </div>
              <div className="bg-white dark:bg-gray-800 p-6 rounded-2xl border border-gray-100 dark:border-gray-700 shadow-sm flex items-start gap-4">
                ...
                <div>
                  ...
                  <p className="text-sm text-gray-500 dark:text-gray-400">Competitive pricing with customized care packages available.</p>
                </div>
              </div>
              <div className="bg-white dark:bg-gray-800 p-6 rounded-2xl border border-gray-100 dark:border-gray-700 shadow-sm flex items-start gap-4">
                ...
                <div>
                  ...
                  <p className="text-sm text-gray-500 dark:text-gray-400">Led by a team of {clinic.doctors_count || 'several'} expert specialists dedicated to women's health.</p>
                </div>
              </div>
              <div className="bg-white dark:bg-gray-800 p-6 rounded-2xl border border-gray-100 dark:border-gray-700 shadow-sm flex items-start gap-4">
                ...
                <div>
                  ...
                  <p className="text-sm text-gray-500 dark:text-gray-400">Centrally situated in {displayCity}, ensuring highly accessible consultation visits.</p>
                </div>
              </div>
            </div>
          </div>
