...
export default function IVFClinicsLandingPage() {
  return (
        ...
        <div className="max-w-7xl mx-auto px-6 text-center">
          ...
          <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-6 max-w-5xl mx-auto">
            {CITIES.map((city) => (
              <Link 
                key={city.slug} 
                href={`/ivf-clinics/${city.slug}`}
                className="bg-gray-50 dark:bg-gray-800/50 hover:bg-teal-50 dark:hover:bg-teal-900/20 border border-gray-100 dark:border-gray-800 rounded-2xl p-8 text-center transition-all duration-300 hover:shadow-lg hover:-translate-y-1.5 group"
              >
