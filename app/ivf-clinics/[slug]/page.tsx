          ...
          <div className="mt-20 border-t border-gray-200  pt-16">
            ...
            <div className="grid md:grid-cols-3 gap-8">
              ...
              <div className="bg-white  p-8 rounded-2xl shadow-sm border border-gray-100  hover:shadow-md transition-shadow">
                ...
                <h3 className="text-xl font-bold mb-3 text-gray-900 ">State-of-the-Art Labs</h3>
                <p className="text-gray-600  leading-relaxed">
              ...
              <div className="bg-white  p-8 rounded-2xl shadow-sm border border-gray-100  hover:shadow-md transition-shadow">
                ...
                <h3 className="text-xl font-bold mb-3 text-gray-900 ">Expert Fertility Specialists</h3>
                <p className="text-gray-600  leading-relaxed">
          ...
          <div className="flex flex-col lg:flex-row lg:items-start justify-between gap-10 mt-10">
            ...
            <div className="lg:w-80 flex-shrink-0 bg-white  p-6 rounded-2xl border border-gray-200  shadow-xl lg:sticky lg:top-24">
              ...
              <div className="space-y-4">
                ...
                <Link href={`/ivf-clinics/${clinic.city_slug}`} className="w-full flex items-center justify-center gap-2 py-3 px-4 bg-gray-50  text-gray-700  hover:bg-gray-100 :bg-gray-700 font-bold rounded-xl transition-colors border border-gray-200  text-sm">
                   Compare Clinics
                </Link>
              </div>
            </div>
          ...
          <div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div className="bg-white  p-6 rounded-2xl border border-gray-100  shadow-sm flex items-start gap-4">
                ...
                <div>
                  <h3 className="font-bold text-gray-900  mb-1">High Success Rate</h3>
                  <p className="text-sm text-gray-500 ">Maintaining a robust clinical pregnancy rate of {clinic.success_rate || '70-75%'} across all age groups.</p>
                </div>
              </div>
              <div className="bg-white  p-6 rounded-2xl border border-gray-100  shadow-sm flex items-start gap-4">
                ...
                <div>
                  ...
                  <p className="text-sm text-gray-500 ">Cost range generally between {clinic.cost_range || 'N/A'} with customized financial packages available.</p>
                </div>
              </div>
              <div className="bg-white  p-6 rounded-2xl border border-gray-100  shadow-sm flex items-start gap-4">
                ...
                <div>
                  ...
                  <p className="text-sm text-gray-500 ">Led by a team of {clinic.doctors_count || 'several'} expert specialists dedicated to reproductive medicine.</p>
                </div>
              </div>
              <div className="bg-white  p-6 rounded-2xl border border-gray-100  shadow-sm flex items-start gap-4">
                ...
                <div>
                  ...
                  <p className="text-sm text-gray-500 ">Centrally situated in {displayCity}, ensuring highly accessible follow-up consultation visits.</p>
                </div>
              </div>
            </div>
          </div>
