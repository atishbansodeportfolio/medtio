          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="max-w-3xl">
              <h1 className="text-4xl md:text-5xl font-extrabold text-gray-900 dark:text-white tracking-tight mb-6 mt-10">
                Top 10 Gynecologists in <span className="text-teal-600 dark:text-teal-400">{displayCity}</span>
              </h1>
          ...
          <div className="flex flex-col lg:flex-row lg:items-start justify-between gap-10 mt-10">
              ...
              <div>
                ...
                <div className="grid grid-cols-2 md:grid-cols-5 gap-3 md:gap-4 mb-2">
                   <div className="bg-gray-50 dark:bg-gray-700/50 p-4 rounded-xl border border-gray-100 dark:border-gray-700">
                     ...
                     <div className="text-lg font-bold text-gray-900 dark:text-white">{doctor.experience_years ? `${doctor.experience_years} Years` : 'Experienced'}</div>
                   </div>
                   <div className="bg-gray-50 dark:bg-gray-700/50 p-4 rounded-xl border border-gray-100 dark:border-gray-700">
            ...
            <div className="lg:w-80 flex-shrink-0 bg-white dark:bg-gray-800 p-6 rounded-2xl border border-gray-200 dark:border-gray-700 shadow-xl lg:sticky lg:top-24">
              ...
              <div className="space-y-4">
                ...
                <Link href={`/gynecology-doctors/${doctor.city_slug}`} className="w-full flex items-center justify-center gap-2 py-3 px-4 bg-gray-50 dark:bg-gray-800 text-gray-700 dark:text-gray-300 hover:bg-gray-100 dark:hover:bg-gray-700 font-bold rounded-xl transition-colors border border-gray-200 dark:border-gray-600 text-sm">
                  Compare Doctors
                </Link>
              </div>
            </div>
          ...
          <div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
               <div className="bg-white dark:bg-gray-800 p-6 rounded-2xl border border-gray-100 dark:border-gray-700 shadow-sm flex items-start gap-4">
                ...
                <div>
                  <h3 className="font-bold text-gray-900 dark:text-white mb-1">Experienced Specialist</h3>
                  <p className="text-sm text-gray-500 dark:text-gray-400">In-depth specialized training with years of dedicated patient care management.</p>
                </div>
              </div>
              <div className="bg-white dark:bg-gray-800 p-6 rounded-2xl border border-gray-100 dark:border-gray-700 shadow-sm flex items-start gap-4">
                ...
                <div>
                  <h3 className="font-bold text-gray-900 dark:text-white mb-1">High Standard of Care</h3>
                  <p className="text-sm text-gray-500 dark:text-gray-400">Strives for superior clinical outcomes through optimized treatment protocols.</p>
                </div>
              </div>
              <div className="bg-white dark:bg-gray-800 p-6 rounded-2xl border border-gray-100 dark:border-gray-700 shadow-sm flex items-start gap-4">
                ...
                <div>
                  ...
                  <p className="text-sm text-gray-500 dark:text-gray-400">Tailoring every intervention precisely to the patient&apos;s unique health profile.</p>
                </div>
              </div>
              <div className="bg-white dark:bg-gray-800 p-6 rounded-2xl border border-gray-100 dark:border-gray-700 shadow-sm flex items-start gap-4">
                ...
                <div>
                  ...
                  <p className="text-sm text-gray-500 dark:text-gray-400">Operating out of {doctor.clinic_name || 'reputed hospitals'}, heavily audited for ethical standards.</p>
                </div>
              </div>
            </div>
          </div>
